...
CREATE USER gabriel WITH ENCRYPTED PASSWORD '12345';
--Comando para criar o banco de dados uvv
...
--Comando para criar o SCHEMA lojas
CREATE SCHEMA lojas;
--Comando para garantir acesso do schema para o usuario criado
GRANT USAGE ON SCHEMA lojas TO gabriel;
--Usar o schema lojas
SET search_path TO lojas, "$user",public;

--Implementar o projeto lógico lojas uvv
